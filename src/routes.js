...
const routes = [
  ...
  { path: '/admin/category', name: 'Category List', element: Category },
  { path: '/admin/sliders', name: 'Sliders List', element: Slider },
  { path: '/admin/astrologer-list', name: 'Astrologer List', element: Astrologer },
  { path: '/admin/user-list', name: 'Users List', element: Users },
  { path: '/admin/product-category-list', name: 'Product Category List', element: ProductCategory },
  { path: '/admin/blogs-list', name: 'Blog List', element: Blogs },
